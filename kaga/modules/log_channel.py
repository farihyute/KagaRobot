        ...
        if chat.type == chat.CHANNEL:
            ...
            try:
                ...
                if excp.message == "Message to delete not found":
                    ...
                    LOGGER.exception(
                        "Terjadi kesalahan saat menghapus pesan di saluran log. Bagaimanapun juga harus bekerja."
                    )
            ...
            try:
                ...
                if excp.message == "Forbidden: bot is not a member of the channel chat":
                    ...
                    LOGGER.exception("GAGAL dalam mengatur saluran log.")
    ...
    def unsetlog(update: Update, context: CallbackContext):
        ...
        if log_channel:
            bot.send_message(log_channel,
                             f"Tautan saluran telah dibatalkan dari {chat.title}")
